...
mean, which makes no normality assumption, and short-premium P\&L is sharply
left-skewed.}
\label{tab:vrp}
\centering
\scriptsize
...
\toprule
\textbf{DTE} & $\boldsymbol{n}$ & \textbf{Win} & \textbf{Net} & \textbf{s.d.} &
$\boldsymbol{t}$ & $\boldsymbol{p}$ & \textbf{95\,\% CI} \\
\midrule
\multicolumn{8}{@{}l@{}}{\emph{NIFTY} (weekly expiries, median gap 7 days)} \\
...
\midrule
\multicolumn{8}{@{}l@{}}{\emph{BANKNIFTY} (monthly expiries, median gap 27 days)} \\
...
\bottomrule
\multicolumn{8}{@{}l@{}}{\scriptsize Net and s.d.\ in index points. \textbf{0 of 4}
configurations are significantly profitable on either} \\
\multicolumn{8}{@{}l@{}}{\scriptsize index, before or after Benjamini--Hochberg.
